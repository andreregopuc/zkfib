...
Fr_lt(&expaux[0],&lvar[5],&circuitConstants[0]); // line circom 14
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &lvar[3];
// load src
Fr_add(&expaux[0],&lvar[1],&lvar[2]); // line circom 15
// end load src
...
PFrElement aux_dest = &lvar[5];
// load src
Fr_add(&expaux[0],&lvar[5],&circuitConstants[3]); // line circom 14
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[5],&circuitConstants[0]); // line circom 14
...
// load src
Fr_mul(&expaux[0],&lvar[3],&signalValues[mySignalStart + 1]); // line circom 19
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
